...
# CSV log file. This stores text and sensor data, not every WAV audio file.
LOG_DIR = Path("logs")
...
def append_broadcast_log(status, audio_generated, audio_sent_mqtt):
    ...
    while True:
        ...
        try:
            ...
            if audio_generated:
                ...
                print("Audio generation failed. Nothing was sent.")
...
def main():
    print("Starting Talking Plant automatic broadcast controller with CSV logging...")
